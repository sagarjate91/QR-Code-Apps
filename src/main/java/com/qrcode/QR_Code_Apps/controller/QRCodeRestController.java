...
public class QRCodeRestController {
    ...
    public String generateQRCode(@RequestParam("fileName") String fileName) {
        if (fileName == null || fileName.isEmpty()) {
            return "mobile cannot be null or empty";
        }
        QRCodeService qrCodeService = new QRCodeService();
        qrCodeService.generateQRCode(fileName);

        return "QR Code generated successfully for: " + fileName;
    }
